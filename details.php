...
<body>
          ...
          <li class="nav-item">
		   ...
		   <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownBlog">
              <a class="dropdown-item" href="blog-home-1.html">Edit Profile</a>
  ...
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Tolani Bello</li>
    </ol>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <img class="img-fluid" src="profile/p1.jpg" alt="">
      </div>

      <div class="col-md-4">
        <h3 class="my-3">Profile</h3>
        <p>A well-bred software developer who can turn any idea into business using technology.</p>
        <h3 class="my-3">Project Details</h3>
        <ul>
          <li>Email Address: a@b.com</li>
          <li>Phone: 080876543</li>
